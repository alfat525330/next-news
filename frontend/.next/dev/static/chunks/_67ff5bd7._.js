...
"[project]/lib/client-api.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function apiRequest(url, method = 'get', data = null, options = {}) {
    try {
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(config);
        return res.data;
    } catch (error) {
        return {
            status: false,
...
"[project]/services/news.client.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$client$2d$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/client-api.js [app-client] (ecmascript)");
;
async function addNews(data) {
    try {
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$client$2d$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('/api/news/', 'post', data);
        console.log('res', res);
        return res;
    } catch (error) {
        return {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$news$2e$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/news.client.js [app-client] (ecmascript)");
;
...
function AddNewsPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const { status, message, details } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$news$2e$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addNews"])(formData);
            console.log('response', status, message, details);
            if (status == true) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(message || 'News added successfully');
                form.reset();
                setPreview(null);
                setErrors({});
                setTimeout(()=>{
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(message || 'Failed to add news');
            }
        } catch (err) {
...
_s(AddNewsPage, "wLCQwx+SByPl1fvcnrO8Q5s7W0Q=", false, function() {
    return [
...
//# sourceMappingURL=_67ff5bd7._.js.map